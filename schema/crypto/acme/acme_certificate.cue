...
module: acme_certificate: {
	...
	description: [
		...
		"The module includes experimental support for IP identifiers according to the L(current ACME IP draft,https://tools.ietf.org/html/draft-ietf-acme-ip-05).",
	]

	notes: [
		"At least one of C(dest) and C(fullchain_dest) must be specified.",
		"This module includes basic account management functionality. If you want to have more control over your ACME account, use the M(acme_account) module and disable account management for this module using the C(modify_account) option.",
