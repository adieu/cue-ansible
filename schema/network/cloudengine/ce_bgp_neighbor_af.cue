...
module: ce_bgp_neighbor_af: {
	...
	options: {
		...
		allow_as_loop_limit: description: [
		...
		route_limit_percent: description: [
		...
		route_limit_idle_timeout: description: [
		...
		import_pref_filt_name: description: [
		...
		export_pref_filt_name: description: [
		...
		import_as_path_filter: description: [
		...
		export_as_path_filter: description: [
		...
		export_acl_name_or_num: description: [
		...
		default_rt_adv_policy: description: [
