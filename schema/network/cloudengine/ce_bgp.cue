...
module: ce_bgp: {
	...
	options: {
		...
		suppress_interval: description: [
			"Suppress interval.",
		]
		hold_interval: description: [
			"Hold interval.",
		]
		clear_interval: description: [
			"Clear interval.",
		]
		confed_peer_as_num: description: [
