...
module: ce_bgp_af: {
	...
	options: {
		...
		maximum_load_balance: description: [
		...
		rib_only_policy_name: description: [
		...
		reflector_cluster_id: description: [
		...
		nhp_relay_route_policy_name: description: [
		...
		ingress_lsp_policy_name: description: [
