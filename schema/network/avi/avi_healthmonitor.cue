...
module: avi_healthmonitor: {
	...
	options: {
		...
		dns_monitor: description: [
			"Healthmonitordns settings for healthmonitor.",
		]
		external_monitor: description: [
		...
		http_monitor: description: [
			"Healthmonitorhttp settings for healthmonitor.",
		]
		https_monitor: description: [
			"Healthmonitorhttp settings for healthmonitor.",
		]
		is_federated: {
			description: [
		...
		successful_checks: description: [
			"Number of continuous successful health checks before server is marked up.",
			"Allowed values are 1-50.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 2.",
		]
		tcp_monitor: description: [
