...
module: avi_serviceenginegroup: {
	...
	options: {
		...
		auto_rebalance_interval: description: [
		...
		connection_memory_percentage: description: [
		...
		floating_intf_ip_se_2: description: [
			"If serviceenginegroup is configured for legacy 1+1 active standby ha mode, floating ip's will be advertised only by the active se in the pair.",
			"Virtual services in this group must be disabled/enabled for any changes to the floating ip's to take effect.",
		...
		host_attribute_key: description: [
		...
		host_attribute_value: description: [
		...
		max_scaleout_per_vs: description: [
		...
		mgmt_network_ref: description: [
			"Management network to use for avi service engines.",
			"It is a reference to an object of type network.",
		]
		mgmt_subnet: description: [
			"Management subnet to use for avi service engines.",
		]
		min_cpu_usage: description: [
		...
		min_scaleout_per_vs: description: [
		...
		non_significant_log_throttle: description: [
		...
		num_flow_cores_sum_changes_to_ignore: description: [
			"Number of changes in num flow cores sum to ignore.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 8.",
		]
		openstack_availability_zone: description: [
			"Field deprecated in 17.1.1.",
		]
		openstack_availability_zones: description: [
			"Field introduced in 17.1.1.",
		]
		openstack_mgmt_network_name: description: [
			"Avi management network name.",
		]
		openstack_mgmt_network_uuid: description: [
			"Management network uuid.",
		]
		os_reserved_memory: description: [
		...
		realtime_se_metrics: description: [
		...
		se_deprovision_delay: description: [
		...
		se_thread_multiplier: description: [
		...
		se_tunnel_udp_port: description: [
		...
		se_vs_hb_max_pkts_in_batch: description: [
			"Maximum number of aggregated vs heartbeat packets to send in a batch.",
			"Allowed values are 1-256.",
			"Field introduced in 17.1.1.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 64.",
		]
		se_vs_hb_max_vs_in_pkt: description: [
		...
		service_ip_subnets: description: [
		...
		significant_log_throttle: description: [
		...
		vcenter_datastore_mode: description: [
		...
		vcenter_datastores: description: [
		...
		vcenter_hosts: description: [
			"Vcenterhosts settings for serviceenginegroup.",
		]
		vcpus_per_se: description: [
