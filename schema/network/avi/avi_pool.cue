...
module: avi_pool: {
	...
	options: {
		...
		autoscale_networks: description: [
			"Network ids for the launch configuration.",
		]
		autoscale_policy_ref: description: [
		...
		connection_ramp_duration: description: [
		...
		default_server_port: description: [
		...
		fewest_tasks_feedback_delay: description: [
			"Periodicity of feedback for fewest tasks server selection algorithm.",
			"Allowed values are 1-300.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 10.",
		]
		graceful_disable_timeout: description: [
		...
		health_monitor_refs: description: [
		...
		lb_algorithm_consistent_hash_hdr: description: [
		...
		max_concurrent_connections_per_server: description: [
		...
		max_conn_rate_per_server: description: [
		...
		prst_hdr_name: description: [
			"Header name for custom header persistence.",
			"Field deprecated in 18.1.2.",
		]
		request_queue_depth: description: [
		...
		ssl_key_and_certificate_ref: description: [
