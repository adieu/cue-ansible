...
module: avi_controllerproperties: {
	...
	options: {
		...
		attach_ip_retry_interval: description: [
			"Number of attach_ip_retry_interval.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 360.",
		]
		attach_ip_retry_limit: description: [
		...
		cluster_ip_gratuitous_arp_period: description: [
		...
		crashed_se_reboot: description: [
			"Number of crashed_se_reboot.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 900.",
		]
		dead_se_detection_timer: description: [
			"Number of dead_se_detection_timer.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 360.",
		]
		dns_refresh_period: description: [
		...
		fatal_error_lease_time: description: [
			"Number of fatal_error_lease_time.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 120.",
		]
		max_dead_se_in_grp: description: [
			"Number of max_dead_se_in_grp.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 1.",
		]
		max_pcap_per_tenant: description: [
		...
		max_seq_vnic_failures: description: [
			"Number of max_seq_vnic_failures.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 3.",
		]
		persistence_key_rotate_period: description: [
		...
		se_create_timeout: description: [
			"Number of se_create_timeout.",
			"Default value when not specified in API or module is interpreted by Avi Controller as 900.",
		]
		se_failover_attempt_interval: description: [
		...
		upgrade_lease_time: description: [
