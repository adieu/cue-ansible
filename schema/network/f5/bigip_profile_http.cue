	...
	options: {
			...
			suboptions: {
				truncated_redirects: {
					description: [
						...
						"If C(yes), the redirect will be forwarded to the client, otherwise the malformed HTTP will be silently ignored.",
						"When creating a new profile, if this parameter is not specified, the default is provided by the parent profile.",
					]
				...
				pipeline: {
					description: [
						...
						"If set to C(pass-through), pipelined data will cause the BIG-IP to immediately switch to pass-through mode and disable the HTTP filter.",
						"When creating a new profile, if this parameter is not specified, the default is provided by the parent profile.",
					]
				...
				max_requests: {
					description: [
						...
						"The valid value range is between 0 and 4294967295 inclusive.",
						"When set to C(default) the value of this parameter will be C(0), which means the system will not limit the number of requests per connection.",
						"When creating a new profile, if this parameter is not specified, the default is provided by the parent profile.",
					]
				...
				known_methods: {
					description: [
						...
						"The default list provided with the system include: C(CONNECT), C(DELETE), C(GET), C(HEAD), C(LOCK), C(OPTIONS), C(POST), C(PROPFIND), C(PUT), C(TRACE) ,C(UNLOCK). The list can be appended by by specifying C(default) keyword as one of the list elements.",
		...
		sflow: {
			...
			suboptions: {
				...
				sampling_rate: {
					description: [
						"Specifies the ratio of packets observed to the samples generated. For example, a sampling rate of C(2000) specifies that 1 sample will be randomly generated for every 2000 packets observed.",
