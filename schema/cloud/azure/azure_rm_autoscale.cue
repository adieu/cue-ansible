	...
	options: {
		...
		profiles: {
			...
			suboptions: {
				...
				recurrence_timezone: description: [
				...
				rules: {
					...
					suboptions: {
						...
						metric_resource_uri: description: [
