...
module: azure_rm_aks: {
	...
	options: {
		...
		dns_prefix: description: [
			"DNS prefix specified when creating the managed cluster.",
		]
		kubernetes_version: description: [
		...
		aad_profile: {
			...
			suboptions: {
				client_app_id: description: "The client AAD application ID."
				server_app_id: description: "The server AAD application ID."
				server_app_secret: description: "The server AAD application secret."
			...
			suboptions: {
				...
				monitoring: {
					...
					suboptions: {
						...
						log_analytics_workspace_resource_id: description: [
				...
				virtual_node: {
					...
					suboptions: {
						...
						subnet_resource_id: description: [
