...
module: k8s_auth: {
	...
	options: {
		...
		username: description: ["Provide a username for authenticating with the API server."]
		password: description: ["Provide a password for authenticating with the API server."]
		ca_cert: {
			description: [
		...
		api_key: description: ["When C(state) is set to I(absent), this specifies the token to revoke."]
	}
	requirements: [
		"python >= 2.7",
		"urllib3",
