	...
	options: {
		...
		drive_type: {
			description: [
				...
				"Option only applies when configuration mode is automatic.",
			], choices: ["unspecified", "HDD", "SSD"], default:
				"unspecified"
		}, num_ded_hot_spares: {
			description: [
			...
			description: [
				...
				name: {
					description: ["The name of the local LUN."]
					required: true
				}
				slot_num: description: ["The slot number of the specific disk."]
				role: description: [
				...
				span_id: {
					description: ["The Span ID of the specific disk."]
					default: "unspecified"
				}
				state: {
					description: [
