...
module: win_nssm: {
	...
	notes: [
		...
		"Once the service is created, you can use the M(win_service) module to start it or configure some additionals properties, such as its startup type, dependencies, service account, and so on.",
	]
